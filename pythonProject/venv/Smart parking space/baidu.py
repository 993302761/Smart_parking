...
APP_ID = '25192841'
API_KEY = 'xnVLZSTgi7tSUgMcqcBC7lXl'
SECRET_KEY = 'hY58zfLF6pDcEWQVIsG5WHBDnZ8BkgoD'
...
def Action(Basepath, frame, first):
    now = time.localtime()
    ...
    if p0 == 0:
        ...
        # 定一个字典类型
        mapA = {"License_plate": s0, "color": color0, "time": nowt, "id": "1001"}
        # 把字典转成字符串
...
if __name__ == '__main__':
    # 设置要访问的地址
    url = 'http://10.12.43.90:8080/pythonToJavaTest'
    show()
