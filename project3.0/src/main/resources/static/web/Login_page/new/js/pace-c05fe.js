                         ...
                         t.prototype.off = function(t, e) {
                             ...
                             if (null != (null != (r = this.bindings) ? r[t] : void 0)) {
                                 ...
                                 for (n = 0,
                                     ...
                                     s.push(this.bindings[t][n].handler === e ? this.bindings[t].splice(n, 1) : n++);
                                 return s
                             }
                         }
                         ,
                             ...
                             if (n = arguments[0],
                                 ...
                                 for (s = 0,
                                     ...
                                     u = this.bindings[n][s],
                                         ...
                                         a.push(o ? this.bindings[n].splice(s, 1) : s++);
                                 return a
                             }
                         }
                         ,
        ...
        a = function(t) {
            ...
            L().on("request", function(e) {
                ...
                return o = e.type,
                    s = e.request,
                    i = e.url,
                    N(i) ? void 0 : c.running || j.restartOnRequestAfter === !1 && "force" !== _(o) ? void 0 : (r = arguments,
                        n = j.restartOnRequestAfter || 0,
                    "boolean" == typeof n && (n = 0),
                        setTimeout(function() {
                            var e, n, i, u, a, l;
                            if (e = "socket" === o ? s.readyState < 2 : 0 < (u = s.readyState) && 4 > u) {
                                for (c.restart(),
                                         a = c.sources,
                                         l = [],
                                         n = 0,
            ...
            t = function() {
                ...
                return t.prototype.watch = function(t) {
                    ...
                    return r = t.type,
                        e = t.request,
                        s = t.url,
                        N(s) ? void 0 : (n = "socket" === r ? new f(e) : new d(e),
                    ...
                    null != window.ProgressEvent)
                        for (n = null,
                                 t.addEventListener("progress", function(t) {
                                     return u.progress = t.lengthComputable ? 100 * t.loaded / t.total : u.progress + (100 - u.progress) / 2
                                 }, !1),
